...
# endif
   ...
   SUBROUTINE tam_tst_init
      ...
      NAMELIST/namtst_tam/ ln_swi_opatam, ln_tl_passive_tracer, cn_tl_passive_init, ln_tl_eiv, &
      &                    rn_tl_adv_ups, ln_tl_nasmw_auto, nn_tl_nasmw_freq, ln_tl_surf_remove, &
      &                    ln_edw_auto
      ...
      ln_swi_opatam  = 0
      ! 2016-03-03 added switch for passive tracer transport
      ln_tl_passive_tracer = .false.
      ! 2016-05-16 added variable for name of initial tracer distribution
      cn_tl_passive_init = 'tl_passive_init.nc'
      ! 2016-05-16 added switch for including EIV transport in trajectory
      ln_tl_eiv = .false.
      ! 2016-05-24 added optional trajectory-upstream advection scheme
      rn_tl_adv_ups = 0.0_wp
      ! 2016-06-09 added switch and frequency for on-line resetting of NASMW
      ln_tl_nasmw_auto = .false.
      ln_edw_auto      = .false. !2016-08-22 switch for auto-seeding edw
      nn_tl_nasmw_freq = 1
      !2016-06-22 added switch for surface removal and storage of tracer
      ln_tl_surf_remove = .false.
      ...
      IF (lwp) THEN                 ! control print
         ...
         ! 2016-03-03 added switch for passive tracer transport
	 WRITE(numout,*) '      passive tracer transport?          ln_tl_passive_tracer =', ln_tl_passive_tracer
         ! 2016-05-16 added variable for name of initial tracer distribution
	 ...
	 ! 2016-05-24 added optional trajectory-upstream advection scheme
	 WRITE(numout,*) '      weight centred/traj.-upstream adv. ln_tl_adv_ups =', rn_tl_adv_ups
         ! 2016-06-09 added switch and frequency for on-line resetting of NASMW
	 WRITE(numout,*) '                                         ln_tl_nasmw_auto = ', ln_tl_nasmw_auto
	 WRITE(numout,*) '                                         nn_tl_nasmw_freq = ', nn_tl_nasmw_freq
         ! 2016-06-22 added switch for surface removal and storage of tracer
         WRITE(numout,*) '                                         ln_tl_surf_remove = ', ln_tl_surf_remove
