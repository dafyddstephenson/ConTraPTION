...
CONTAINS
   ...
   SUBROUTINE nemo_gcm_tam
      ...
      ! 1: Initialise passive tracer functionality
      CALL pt_init
      ...
      ELSEIF (ln_swi_opatam == 3) THEN
         ...
         CALL pt_tan
         ! 2a: Call passive tracer TLM subroutine

      ELSEIF (ln_swi_opatam == 4) THEN

         CALL pt_adj
         ! 2b: Call passive tracer adjoint subroutine

      ELSE
         CALL tam_tst
      ENDIF

      ! 3: Initialise passive tracer functionality
      CALL pt_init
